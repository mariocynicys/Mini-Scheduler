...
int main(int agrc, char *argv[])
{
	...
	// (WHAT I THINK IS THAT THIS IS SOME SORT OF STACK CURROPTION DUE TO USING execv 2 TIMES TO CREATE THIS PROCESS, FORM THE PROCESS GENRATOR TO THE SCHEDULER DOWN TO A SINGLE PROCESS)
