...
// MAX_PROC_TABLE_SIZE needs to be powers of 2, that is because [(unsinged int)(-1) % (powerOf2Number) = powerOf2Numer-1], this serves when the 0 overflows to -1, it goes back to (MAX_PROC_TABLE_SIZE-1)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///
///////////////////////////////////////////////////////////////////////////////////////////////////
///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///
///////////////////////////////////////////////////////////////////////////////////////////////////
///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///SOME HELPER FUNCTIONS///
...
// and the scheduler, we are using a shared mem + semaphores bcz we hate msg queues
// this fucntion is only called by process_generator.c
void initComGenSch()
{
	// Shared memory
	...
	if (shm == -1 || sem == -1)
	{
		perror("Error while creating the communication channel between Proc_generator & Scheduler");
		exit(-1);
	}
...
int getsem()
{
	return semget(COM_GEN_SCH, 1, 0666);
}

// Get the shm made @initComGenSch
int getshm()
{
	return shmget(COM_GEN_SCH, 4, 0666);
}
